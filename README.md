Project is Deployed [here](https://roar-htpf08hwp-pranayharishchandras-projects.vercel.app/)
...
@layer components {
  ...
  .community-card_btn {
    @apply rounded-lg bg-cyan-700 px-5 py-1.5 text-small-regular !text-light-1 !important;
  }
  ...
  .user-card_btn {
    @apply h-auto min-w-[74px] rounded-lg bg-cyan-700 text-[12px] text-light-1 !important;
  }
...
.comment-form_btn {
  @apply rounded-3xl bg-cyan-700 px-8 py-2 !text-small-regular text-light-1 max-xs:w-full !important;
}
```
